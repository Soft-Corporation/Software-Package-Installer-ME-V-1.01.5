...
Public Class Python
    ...
    Private Sub Python_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4207ed45ef304c0fb613ba620181e127.zip"), Texbbb.TextBox37.Text)
