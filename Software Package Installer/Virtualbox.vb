...
Public Class Virtualbox
    ...
    Private Sub Virtualbox_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_6035bfc462f8497d9c17c33fdacaca8d.zip"), Texbbb.TextBox14.Text)
        Timer1.Start()
