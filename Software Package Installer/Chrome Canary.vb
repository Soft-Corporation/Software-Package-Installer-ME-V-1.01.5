...
Public Class Chrome_Canary
    ...
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_e018165cd0d24c43beddefeccdfac1aa.zip"), Texbbb.TextBox53.Text)
        Timer1.Start()
